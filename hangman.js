...
import { HangmanElements } from "./hangmanElements.js";
import { HangmanGameLogic } from "./hangmanGameLogic.js";
...
class HangmanGame {
  constructor() {
    ...
    this.hangmanElements = new HangmanElements(this.container);

    this.gameLogic = new HangmanGameLogic(this.container, this.hangmanElements);
